...
function Navbar({ currentPage } : {currentPage: string}): JSX.Element {
    return <> <div className="navbar navbar-expand-lg custom-navbar">
            ...
            <div className="collapse navbar-collapse" id="navbaroptions">
                <ul className="navbar-nav ms-auto">
                    <li className="nav-item">
                        <a className={`nav-link ${currentPage==='home' && 'active'}`} href="/">
                    ...
                    <li className="nav-item">
                        <a className={`nav-link ${currentPage==='blogs' && 'active'}`} href="/blogs">
                            <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    ...
                    <li className="nav-item">
                        <a className={`nav-link ${currentPage==='about' && 'active'}`} href="/about">
                            <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    ...
                    <li className="nav-item">
                        <a className={`nav-link ${currentPage==='contact' && 'active'}`} href="/contact">
                            <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
